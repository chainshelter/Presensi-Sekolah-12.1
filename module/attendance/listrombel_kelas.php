<?php
    // TAG : 25012021.2 : Update Menampilkan List berdasarkan dan tanpa berdasarkan Jurusan
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if (trim($_POST['kode_jurusan']) == "") {            
            ...
            if($total_datasiswa['total_datasiswa'] == 0) {
                ...
                $response["informasi"] = "Filter tanpa Jurusan";
                $response["total_siswa"] = $total_datasiswa['total_datasiswa'];
            ...
            if($total_datasiswa['total_datasiswa'] == 0) {
                ...
                $response["code"] = 200; // Data ditemukan
                $response["status"] = true;
                $response["informasi"] = "Filter dengan Jurusan";
                $response["total_siswa"] = $total_datasiswa['total_datasiswa'];
                $response["datasiswa"] = array();
